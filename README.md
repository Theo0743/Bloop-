...
Gestion d'un État Complexe et Réactif
...
Fonctionnalité présente sur Bloop : 
Possibilité : Connexions/inscriptions/Deconnexions
Chat en temps réel dans différents Salons
Création de la supabase pour la gestion des connexions et du chat 
Design Creer et personnaliser l'avatar
Personnalisation du profil 
mention des amis
Possibilité de publié des vidéos/Gif
Discussion privé
Recherche d'amis
